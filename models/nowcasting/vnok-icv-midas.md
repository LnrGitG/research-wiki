...
- Спецификации: bridge (бенчмарк), MIDAS-Almon (основной), U-MIDAS (робаст), MFBVAR (лидер РФ-литературы: Станкевич 2020, Фокин 2023), MF-VAR, DFM, structured ML (фирменный блок); горизонт nowcast 0–1 кв. — MIDAS (Kuzin et al. 2011)

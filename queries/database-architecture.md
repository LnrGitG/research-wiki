...
### 14.8. Канонический справочник регионов — ОТКРЫТ

Единственный оставшийся вопрос. Маппинг 339 вариантов имён требует ручных
решений по ~40 неоднозначным кейсам (архаичные автономные округа, «без авт.
округа», слияния 2005–2008). Кто утверждает карту: агент с последующим ревью
или владелец целиком?